...
pub fn build_sample_db() -> CardDatabase {
    ...
    db.insert(CardDef {
        ...
        triggered_abilities: vec![TriggeredAbility {
            trigger: TriggerCondition::APermanentWithSubtypeBecomesTapped(Subtype("Dwarf".into())),
            effect: Effect::CreateToken(TokenDef {
                name: "Treasure".into(),
                card_types: vec![CardType::Artifact],
                power: 0,
    ...
    db.insert(CardDef {
        ...
        activated_abilities: vec![ActivatedAbility {
            cost: ManaCost::zero(),
            requires_tap: true,
            sacrifice_cost: Some(SacrificeCost::Artifacts(2)),
            tap_artifacts_cost: None,
            effect: Effect::CreateToken(TokenDef {
                name: "Dragon".into(),
                card_types: vec![CardType::Creature],
    ...
    db.insert(CardDef {
        ...
        activated_abilities: vec![ActivatedAbility {
            cost: ManaCost::zero(),
            requires_tap: false,
            sacrifice_cost: Some(SacrificeCost::Artifacts(1)),
            tap_artifacts_cost: None,
