...
pub fn build_sample_db() -> CardDatabase {
    ...
    db.insert(CardDef {
        ...
        toughness: Some(1),
        triggered_abilities: vec![TriggeredAbility {
            trigger: TriggerCondition::ADwarfYouControlBecomesTapped,
            effect: Effect::CreateArtifactToken,
    ...
    db.insert(CardDef {
        ...
        activated_abilities: vec![ActivatedAbility {
            cost: ManaCost::zero(),
            requires_tap: false,
            sacrifice_cost: Some(SacrificeCost::AnyArtifact),
            tap_artifact_cost: None,
