...
fn test_60card_training_with_bucketed_abstraction() {
    ...
    let bucketed = BucketedAbstraction;
    let train_cfg = TrainConfig {
        mccfr: McfrConfig { max_depth: 6, max_actions: 300, max_nodes_per_iteration: 0, ..Default::default() },
        abstraction: &bucketed,
        rollout_mode: RolloutMode::Heuristic,
        rollout_strategies: None,
        checkpoint_interval: 0,
...
fn test_60card_rollout_training() {
    ...
    let train_cfg = TrainConfig {
        mccfr: McfrConfig { max_depth: 4, max_actions: 200, max_nodes_per_iteration: 0, ..Default::default() },
        abstraction: &bucketed,
...
fn test_parallel_training_60card() {
    ...
    let bucketed = BucketedAbstraction;
    let train_cfg = TrainConfig {
        mccfr: McfrConfig { max_depth: 5, max_actions: 200, max_nodes_per_iteration: 0, ..Default::default() },
        abstraction: &bucketed,
        rollout_mode: RolloutMode::Heuristic,
        rollout_strategies: None,
        checkpoint_interval: 0,
...
fn test_goldfish_mccfr_training_runs() {
    ...
    let config = McfrConfig { max_depth: 6, max_actions: 300, max_nodes_per_iteration: 0, ..Default::default() };
...
fn test_goldfish_mccfr_vs_greedy_vs_random_kill_turns() {
    ...
    let config = McfrConfig { max_depth: 5, max_actions: 500, max_nodes_per_iteration: 0, ..Default::default() };
...
fn test_goldfish_mccfr_with_abstraction() {
    ...
    let bucketed = BucketedAbstraction;
    let config = McfrConfig { max_depth: 6, max_actions: 500, max_nodes_per_iteration: 0, ..Default::default() };
...
fn test_commander_goldfish_deep_training_convergence() {
    ...
    let bucketed = BucketedAbstraction;
    let config = McfrConfig { max_depth: 6, max_actions: 800, max_nodes_per_iteration: 0, ..Default::default() };
